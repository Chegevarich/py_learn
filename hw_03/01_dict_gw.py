...
if os.path.isfile(file_name) :
	...
	print('''необходимо создать файл с именем sname и заполнить его следующим форматом данных
фамилия;имя		
фамилия;имя
...
фамилия;имя
...
def group_by_name(fl):
	...
	print(out)
while True:
	x = input('\nвыберете действие: \n\t0-вывод ФИ по индексу\n\t1-получить срез\n\t2-ФИ с содержанием в имени какой либо буквы\n\t3- находим группы студентов с одинаковыми именами и создаем списки этих групп\n\tдля выхода нажмите любую кнопку(кроме обозначенных кодов) и ввод : ')
	if x=='0':
		show_one_by_index(d)
	elif x=='1':
